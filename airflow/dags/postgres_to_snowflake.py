...
default_args = {
    ...
    'retries' : 0, #quantas vezes tentar até dar falha
    'retry_delay' : timedelta(minutes=1) #tempo de esperar entre tentativas
}
...
@dag(
    ...
    schedule_interval=timedelta(days=1), #intervalo para rodar a dag
    catchup=False #False faz ligar a dag hoje, ignorando as datas passadas ref: 'start_date'
)
